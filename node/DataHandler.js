...
class DataHandler {
        ...
        FS.readFile(filePath, `utf8`, (err, file) => {
            ...
            for (let i = 0; i < tempArray.length; i++) {
                ...
                finalData[i] = {
                    ...
                    NICK_NAME:  protoArray[i][3],
                    RATING:     protoArray[i][4],
                    LEADER:     protoArray[i][5],
                    DAYS:       protoArray[i][6],
                    NIGHTS:     protoArray[i][7],
                    HALF_DAYS:  protoArray[i][8],
                    SNOWMOBILE: protoArray[i][9],
                    TOBOGGAN:   protoArray[i][10],
                    SCAVENGER:  protoArray[i][11],
                    CPR:        protoArray[i][12],
                    CHAIR:      protoArray[i][13],
                }
            }
    ...
    static updateAllPatrollerData(patrollerData) {
        ...
        let writeLine = `ID,LastName,FirstName,NickName,Rating,Leader,Days,Nights,HalfDays,snowmobile,toboggan,scavenger,cpr,chair\n`;
